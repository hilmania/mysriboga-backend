    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                <form role="form" method="POST" action="{{ url('user/updatepass') }}" class="form-horizontal">
                {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" value="{{ $data->no_telp }}" class="form-control" name="telepon" required disabled/> </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Nama user</label>
                        <div class="col-md-4">
                            <input type="text" value="{{ $data->name }}" class="form-control" name="nama" required disabled/> </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Email</label>
                        <div class="col-md-4">
                            <input type="email" value="{{ $data->email }}" class="form-control" name="email" disabled/> </div>
                    </div>
                    <div class="form-group">
