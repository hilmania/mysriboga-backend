        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold font-green uppercase">Tambah Komunitas</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form role="form" method="POST" action="{{ url('user/community/add') }}" class="form-horizontal">
                {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-3 control-label">Nama komunitas</label>
                        <div class="col-md-3">
                            <input type="text" placeholder="Komunitas Roti Indonesia" class="form-control" name="community" required /> </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Daerah</label>
                        <div class="col-md-3">
                            <input type="text" placeholder="Semarang" class="form-control" name="location" required /> </div>
                    </div>
                    <div class="form-group">
