        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">Jenis Usaha</span>
                </div>
                <div class="tools"> </div>
            </div>
            <a class="btn btn-large green-meadow" href="{{ url('general/usaha/form') }}">+ Tambah Jenis Usaha</a>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>{{ $dt->usaha }}</td>
                            <td>
                                <a class="btn btn-xs default" href="{{ url('general/usaha/edit/'.$dt->id) }}" 
                                    >Edit</a>
                                <a class="btn btn-xs red" href="{{ url('general/usaha/delete/'.$dt->id) }}" 
