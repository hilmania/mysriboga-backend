        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold font-green uppercase">Tambah Kapasitas Produksi</span>
                </div>
            </div>
            <div class="portlet-body form">
            	
                <form role="form" method="POST" action="{{ url('general/kapasitas/update') }}" class="form-horizontal">
                {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-3 control-label">Range Kapasitas</label>
                        <div class="col-md-4">
                            <input type="text" placeholder="Semarang" class="form-control" name="id" required value="{{ $data->id }}" style="display:none"/>
                            <input type="text" placeholder="10 sampai 50 kg terigu/hari" class="form-control" name="kapasitas" required value="{{ $data->range_kuantitas }}"/> </div>
                    </div>
