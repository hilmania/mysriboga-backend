        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold font-green uppercase">Edit Lokasi Pelatihan</span>
                </div>
            </div>
            <div class="portlet-body form">
            	
                <form role="form" method="POST" action="{{ url('general/trainingloc/updatelokasi') }}" class="form-horizontal">
                {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-3 control-label">Kota pelatihan</label>
                        <div class="col-md-4">
                            <input type="text" placeholder="Semarang" class="form-control" name="id" required value="{{ $data->idloc }}" style="display:none"/>
