        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">Kategori FAQ</span>
                </div>
                <div class="tools"> </div>
            </div>
            <a class="btn btn-large green-meadow" href="{{ url('general/katfaq/form') }}">+ Tambah Kategori FAQ</a>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                    <thead>
                        <tr>
                            <th style="display: none"> </th>
                            <th class="none">Kategori FAQ</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a class="btn btn-xs default" href="{{ url('general/katfaq/edit/'.$dt->idfaq_kategori) }}" 
                                    >Edit</a>
                                <a class="btn btn-xs red" href="{{ url('general/katfaq/delete/'.$dt->idfaq_kategori) }}" 
