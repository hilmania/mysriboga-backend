        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">Jenis Industri</span>
                </div>
                <div class="tools"> </div>
            </div>
            <a class="btn btn-large green-meadow" href="{{ url('general/industri/form') }}">+ Tambah Jenis Industri</a>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                    <thead>
                        <tr>
                            <th style="display: none"> </th>
                            <th class="none">Jenis Industri</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a class="btn btn-xs default" href="{{ url('general/industri/edit/'.$dt->id) }}" 
                                    >Edit</a>
                                <a class="btn btn-xs red" href="{{ url('general/industri/delete/'.$dt->id) }}" 
