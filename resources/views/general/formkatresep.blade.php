        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold font-green uppercase">Tambah Kategori Resep</span>
                </div>
            </div>
            <div class="portlet-body form">
            	
                <form role="form" method="POST" action="{{ url('general/katresep/add') }}" class="form-horizontal">
                {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-3 control-label">Kategori Resep</label>
                        <div class="col-md-4">
                            <input type="text" placeholder="Roti" class="form-control" name="kategori" required /> </div>
                    </div>
