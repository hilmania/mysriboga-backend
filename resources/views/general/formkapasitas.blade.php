    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                <form role="form" method="POST" action="{{ url('general/kapasitas/add') }}" class="form-horizontal">
                {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-3 control-label">Range Kapasitas</label>
                        <div class="col-md-4">
                            <input type="text" placeholder="10 sampai 50 kg terigu/hari" class="form-control" name="kapasitas" required /> </div>
                    </div>
