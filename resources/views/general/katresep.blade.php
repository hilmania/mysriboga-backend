        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">Kategori Resep</span>
                </div>
                <div class="tools"> </div>
            </div>
            <a class="btn btn-large green-meadow" href="{{ url('general/katresep/form') }}">+ Tambah Kategori Resep</a>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                    <thead>
                        <tr>
                            <th style="display: none"> </th>
                            <th class="none">Kategori Resep</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a class="btn btn-xs default" href="{{ url('general/katresep/edit/'.$dt->idkat) }}" 
                                    >Edit</a>
                                <a class="btn btn-xs red" href="{{ url('general/katresep/delete/'.$dt->idkat) }}" 
