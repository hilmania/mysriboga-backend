        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">Lokasi Pelatihan</span>
                </div>
                <div class="tools"> </div>
            </div>
            <a class="btn btn-large green-meadow" href="{{ url('general/trainingloc/formlokasi') }}">+ Tambah lokasi</a></td>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>{{ $dt->kota }}</td>
                            <td>
                                <a class="btn btn-xs default" href="{{ url('general/trainingloc/editlokasi/'.$dt->idloc) }}" 
                                    >Edit</a>
                                <a class="btn btn-xs red" href="{{ url('general/trainingloc/delete/'.$dt->idloc) }}" 
