        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold font-green uppercase">Edit Jenis Industri</span>
                </div>
            </div>
            <div class="portlet-body form">
            	
                <form role="form" method="POST" action="{{ url('general/industri/update') }}" class="form-horizontal">
                {{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" placeholder="Noodle" class="form-control" name="industri" required value="{{ $data->nama_industri }}" /> </div>
                    </div>
