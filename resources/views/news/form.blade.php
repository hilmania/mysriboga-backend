        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold font-green uppercase">Tambah Berita</span>
                </div>
            </div>
            <div class="portlet-body form">
            	
                <form role="form" method="POST" action="{{ url('berita/add') }}" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-3 control-label">Judul Berita</label>
                        <div class="col-md-4">
                            <input type="text" placeholder="New News" class="form-control" name="judul_berita" required/> </div>
                    </div>
                    <div class="form-group">
