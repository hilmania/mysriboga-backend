    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                <form role="form" method="POST" action="{{ url('gallery/add') }}" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-3 control-label">Nama album</label>
                        <div class="col-md-4">
                            <input type="text" placeholder="Sriboga Ninja" class="form-control" name="albumname" required/> </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Kota event</label>
                        <div class="col-md-4">
                            <input type="text" placeholder="Sriboga Ninja" class="form-control" name="location" required/> </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Tanggal event</label>
                        <div class="col-md-2">
                            <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd">
                                <input type="text" class="form-control" name="albumdate" readonly required>
                    ...
                    <hr>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Konten album</label>
                        <div class="col-md-9">
