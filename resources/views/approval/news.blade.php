	            ...
	            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="berita">
	                ...
	                <tbody>
	                    ...
	                    <tr class="odd gradeX">
                            ...
                            <td><?php if ($news->status_approval == 1) { echo '<span class="label label-sm label-success"> Approved </span>'; } else echo '<span class="label label-sm label-warning"> Belum Approved </span>'?></td>
                            <td>
