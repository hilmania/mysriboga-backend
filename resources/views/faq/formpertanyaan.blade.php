        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold font-green uppercase">Tambah FAQ</span>
                </div>
            ...
            <div class="portlet-body form">
                ...
                <form role="form" method="POST" action="{{ url('faq/add') }}" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-3 control-label">Pertanyaan</label>
                        <div class="col-md-4">
                            <textarea class="form-control" rows="2" placeholder="" name="question" required></textarea> </div>
                    </div>
                    <div class="form-group">
