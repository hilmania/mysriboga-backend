    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                <form role="form" method="POST" action="{{ url('product/updatecategory') }}" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-3 control-label">Nama grup kategori</label>

                        <div class="col-md-4">
                            <input type="text" value="{{ $category->idgroup }}" class="form-control" name="id" required style="display:none" />
                            <input type="text" placeholder="Super Premium" class="form-control" name="category" value="{{ $category->nama_grup }}" required/> </div>
                    </div>
