...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <a class="btn btn-large green-meadow" href="{{ url('product/form') }}">+ Tambah Produk</a>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                    <thead>
                        <tr>
                            ...
                            <th class="none">Nama produk</th>
                            <th class="none">Kategori produk</th>
                            <th class="none">Deskripsi produk</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>{{ $list->deskripsi_produk }}</td>
                            <td>
                                <a class="btn btn-xs default" href="{{ url('product/edit/'.$list->id) }}" 
                                    >Edit info produk</a>
                                <a class="btn btn-xs red" href="{{ url('product/delete/'.$list->id) }}" 
                                    onclick="return confirm('Anda yakin akan menghapus ini?');">Hapus produk</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
