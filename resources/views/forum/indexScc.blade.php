        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">Forum SCC</span>
                </div>
                <div class="tools"> </div>
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a class="btn btn-xs green-meadow" href="{{ url('forum/scc/'.$forum->id) }}">Lihat Komentar</a>
                                <a class="btn btn-xs default blocksticky-btn" data-id= "{{$forum->id}}" >Block/Sticky</a>
                               {{--  <button class="btn btn-xs default sticky-btn" data-id= "{{$forum->id}}" >Sticky</button> --}}
                                <a class="btn btn-xs red" href="{{ url('forumScc/delete/'.$forum->id) }}" 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form  action="{{ url('blockStickyScc/update') }}" method="post"  role="form">
          {{ csrf_field() }}
